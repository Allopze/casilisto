  ...
  return (
    <div className={`fixed inset-0 z-50 transition-all duration-300 ${isOpen ? 'visible' : 'invisible'}`}>
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto px-4 pt-2 pb-4 space-y-3 relative" ref={scrollContainerRef}>
          {/* Scroll indicator */}
          {showScrollIndicator && (
            <div className="sticky bottom-0 left-0 right-0 h-12 pointer-events-none bg-gradient-to-t from-white to-transparent z-10" />
          )}
          {/* Modo Baco Toggle */}
          <div className="bg-purple-50 p-3 rounded-2xl border border-purple-200 shadow-sm">
          ...
          <button
            ...
            className="w-full py-3 bg-yellow-400 text-yellow-900 font-bold rounded-2xl text-base shadow-sm active:scale-95 transition-transform hover:bg-yellow-500 flex items-center justify-center gap-2"
          >
            <ArrowDownAZ className="w-5 h-5" aria-hidden="true" />
